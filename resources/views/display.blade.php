				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						<form action="{{ route('reg.destroy',$user->id) }}" method="POST">
							@csrf
			   @method('Delete')<button style="border: none; background: none;float: right; color: red" class="delete" data-toggle="modal" type="submit"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button>
			</form>
